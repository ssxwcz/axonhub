...
| [workflows/merge-upstream-prs.md](.agent/rules/workflows/merge-upstream-prs.md) | Manual | Workflow for merging upstream PRs: attribution, PR references, signing |
